    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-500">Add New Product</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <div class="mt-4">
                ...
                <p class="mt-1 text-sm text-gray-500">Create a new product for your coffee shop</p>
            </div>
        </div>
            ...
            <div class="space-y-6">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-1">
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_available" value="1" checked class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <x-card title="Product Image">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Upload a high-quality image of your product. Recommended size: 800x600px or larger.
                    </p>
                </x-card>
