            ...
            <div class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex items-start space-x-2">
                    ...
                    <div class="text-sm text-blue-800">
                        <strong>Tips:</strong> Klik pada kategori di atas untuk memilihnya secara otomatis di form. Ini membantu memastikan kategorisasi pengeluaran yang konsisten.
                    </div>
                </div>
            </div>
        </x-card>
