        ...
        <x-card title="Category Information Guide" class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                @foreach($categoryGuide as $key => $guide)
                    <div class="category-guide-item p-4 rounded-lg {{ $guide['bg'] }} {{ $guide['border'] }} border cursor-pointer hover:shadow-md transition-all duration-200" 
            ...
            <div class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex items-start space-x-2">
                    ...
                    <div class="text-sm text-blue-800">
                        <strong>Tip:</strong> Click on any category above to automatically select it in the form below. This helps ensure consistent categorization of your expenses.
                    </div>
                </div>
            </div>
        </x-card>
            ...
            <div class="space-y-6">
                ...
                <x-card title="Expense Information">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- Kategori pengeluaran dengan informasi warna --}}
                        <div>
                            <x-form.select 
                                name="category" 
                                label="Category"
    ...
    function showCategoryInfo(selectedCategory) {
        ...
        if (selectedCategory) {
            ...
            if (selectedGuide) {
                ...
                // Scroll ke guide item yang dipilih
                selectedGuide.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
            }
        }
    }
...
function showCategorySelectedFeedback(category) {
    ...
    notification.innerHTML = `
        <div class="flex items-center space-x-2">
            ...
            <span class="font-medium">Category selected: ${categoryLabels[category] || category}</span>
        </div>
    `;
