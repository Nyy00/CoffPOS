            ...
            <div>
                ...
                <div class="space-y-8">
                    <div class="flex items-start group">
                        <div class="w-12 h-12 bg-gold rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition duration-300 shadow-md">
                        ...
                        <div class="ml-5">
                            <h3 class="font-bold text-coffee-dark text-lg mb-1">Address</h3>
                            <p class="text-gray-600 leading-relaxed">Jl. Merdeka No. 123<br>Bandung, West Java 40111</p>
                        </div>
                    </div>
                ...
                <div class="mt-10 pt-8 border-t border-gray-100">
                    <h3 class="font-bold text-coffee-dark mb-4 text-lg">Follow Us</h3>
                    <div class="flex gap-4">
                        <a href="#" class="w-10 h-10 bg-coffee-dark rounded-full flex items-center justify-center text-white hover:bg-gold hover:text-coffee-dark transition duration-300 transform hover:scale-110">
...
<section class="py-16 bg-cream">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="rounded-2xl overflow-hidden shadow-xl border-4 border-white">
            <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.833989353594!2d107.6191227!3d-6.9147444!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e64c5e88662f%3A0x37a5d384888c73e3!2sBandung%2C%20Bandung%20City%2C%20West%20Java!5e0!3m2!1sen!2sid!4v1635000000000!5m2!1sen!2sid" 
                width="100%" 
                height="450" 
                style="border:0;" 
                allowfullscreen="" 
